...
let ZhipuAdapter = class ZhipuAdapter {
    constructor(configService) {
        this.configService = configService;
        this.name = 'Zhipu';
        this.baseUrl = 'https://open.bigmodel.cn/api/paas/v4';
        this.apiKey = this.configService.getZhipuApiKey();
    }
    async diagnoseBrand(params) {
        ...
        try {
            ...
            console.error('智谱诊断失败:', error.message);
    ...
    async generateContent(params) {
        ...
        try {
            ...
            console.error('智谱内容生成失败:', error.message);
    ...
    async chat(params) {
        try {
            ...
            console.error('智谱聊天失败:', error.message);
...
exports.ZhipuAdapter = ZhipuAdapter = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_service_1.ConfigService])
], ZhipuAdapter);
//# sourceMappingURL=zhipu.adapter.js.map