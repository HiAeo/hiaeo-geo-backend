...
exports.DoubaoAdapter = void 0;
const common_1 = require("@nestjs/common");
const config_service_1 = require("../../../config/config.service");
const axios_1 = __importDefault(require("axios"));
let DoubaoAdapter = class DoubaoAdapter {
    constructor(configService) {
        this.configService = configService;
        this.name = 'Doubao';
        this.baseUrl = 'https://ark.cn-beijing.volces.com/api/v3';
        this.apiKey = this.configService.getDoubaoApiKey();
    }
    async diagnoseBrand(params) {
        ...
        try {
            ...
            console.error('豆包诊断失败:', error.message);
    ...
    async generateContent(params) {
        ...
        try {
            ...
            console.error('豆包内容生成失败:', error.message);
    ...
    async chat(params) {
        try {
            ...
            console.error('豆包聊天失败:', error.message);
            return { message: { role: 'assistant', content: '抱歉，豆包服务暂时不可用。' } };
        }
    }
    isAvailable() {
...
exports.DoubaoAdapter = DoubaoAdapter = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_service_1.ConfigService])
], DoubaoAdapter);
//# sourceMappingURL=doubao.adapter.js.map