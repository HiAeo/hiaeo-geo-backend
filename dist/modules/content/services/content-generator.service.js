...
4. 格式：Q1: 问题\nA1: 回答`;
    ...
    buildProductDescriptionPrompt(params) {
        return `请为以下产品生成营销描述：
...
6. 格式清晰，使用Markdown`;
    ...
    parseSeoArticleResult(content, keyword) {
    ...
    parseProductDescriptionResult(content, productName) {
        return {
            productName,
    ...
    getSampleSeoArticle(keyword, brandName) {
        return {
...
通过本文，您已经了解了${keyword}的核心内容。希望这份指南对您有所帮助。`,
    ...
    getSampleProductDescription(productName, category) {
        return {
            productName,
