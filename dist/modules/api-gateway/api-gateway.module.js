...
const api_gateway_controller_1 = require("./controllers/api-gateway.controller");
let ApiGatewayModule = class ApiGatewayModule {
};
exports.ApiGatewayModule = ApiGatewayModule;
exports.ApiGatewayModule = ApiGatewayModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([entities_1.ApiKey, entities_1.ApiUsageLog])],
        controllers: [api_gateway_controller_1.ApiGatewayController],
        providers: [services_1.ApiKeyService],
